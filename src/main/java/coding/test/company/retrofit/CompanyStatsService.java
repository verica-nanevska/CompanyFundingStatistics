...
import coding.test.company.pojos.CompanyStats;
...
public class CompanyStatsService {
    ...
    public void printCompanyStats(CompanyStats companyStats) throws RetrofitException, FileNotFoundException {
        ...
        try (
            ...
            companyStats.setFundingStats(printCompanyStats(companyStatisticsData));
    ...
    public static void printCompanyStatsOld(Map<String, List<BigDecimal>> companyStatisticsData) {
    ...
    public static String printCompanyStats(Map<String, List<BigDecimal>> companyStatisticsData) {
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append("Country,# Companies,$ Average funding");
        companyStatisticsData.keySet().stream()
                .map(country ->
                        String.join(",", Arrays.asList(country,
                                String.valueOf(companyStatisticsData.get(country).size()),
    ...
    public static BigDecimal average(final List<BigDecimal> numbers) {
    ...
    public static BigDecimal convertCurrencyToNumber(String currency) throws ParseException {
        return deduceCurrency(currency).multiply(BigDecimal.valueOf(deduceMultiplicationFactor(currency)));
    }
